    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        github = v_flakes.github {
          ...
          # The frontend image bakes the private real_estate_allocation `embeds`
          # bundle, so the release runner needs read access to that repo via the
          # DEPLOY_KEY secret (provision: `git_ops init-deploy-key EV-invest/real_estate_allocation`).
          containerRelease = { registry = "ghcr.io/EV-invest"; deployKey = true; };
          gitignore.extra = ''
        ...
        frontendApp = pkgs.buildNpmPackage {
          ...
          buildPhase = ''
            runHook preBuild
            mkdir -p public/assets public/mfe
