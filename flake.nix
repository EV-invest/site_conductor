{
  inputs = {
    ...
    # Private canonical sources, baked into the frontend image. Each uses an ssh host
    # alias (gh-<repo>) so its own single-repo read-only deploy key is selected; the
    # release runner provisions them via deployKeys below, dev eval via `git_ops`.
    real_estate_allocation.url = "git+ssh://git@gh-real_estate_allocation/ev-invest/real_estate_allocation";
    ...
    blog.url = "git+ssh://git@gh-blog/ev-invest/blog";
    blog.inputs.nixpkgs.follows = "nixpkgs";
    whitepaper.url = "git+ssh://git@gh-whitepaper/ev-invest/whitepaper";
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        github = v_flakes.github {
          ...
          containerRelease = { registry = "ghcr.io/EV-invest"; deployKeys = [ "real_estate_allocation" "blog" "whitepaper" ]; };
          gitignore.extra = ''
