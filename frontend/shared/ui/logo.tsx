...
// so the monochrome `currentColor` fill follows the surrounding text color.
//
...
export function Logo({ className, withBackground = false }: LogoProps) {
  const mark = (
    ...
    >
      {/* crown mark */}
      <path d="M0.120605 130.841L140.84 112.176V61.7481L156.149 65.3501V104.786L163.641 103.662V66.6599L178.625 69.607V102.353L185.791 101.043V61.0932L156.475 48.3224L119.992 60.4383V101.043L0.120605 130.841Z" />
      <path d="M213.479 112.176L237.584 114.469L237.258 0.841309L202.078 19.8338V72.8816L213.479 78.1209V112.176Z" />
      <path d="M240.841 0.841309L276.347 20.1612V117.743L260.711 115.778V26.3829L240.841 15.9043V0.841309Z" />
      <path d="M284.816 118.725L386.121 127.239L304.36 109.884V74.1914L284.816 63.7128V118.725Z" />
      {/* INVEST wordmark */}
      <path d="M25.1206 333.987H31.6206V306.987H25.1206V333.987Z" />
      <path d="M92.6206 333.987H100.121L110.621 307.487H104.621L96.6206 325.987L88.6206 307.487H81.6206L92.6206 333.987Z" />
      <path d="M44.6206 333.987H51.6206V318.987L65.1206 333.987H71.6206V307.487H65.1206V322.987L50.6206 307.487H44.6206V333.987Z" />
      ...
      {/* EV monogram */}
      <path d="M232.621 276.02L166.121 145.841H204.905L255.905 246.341L306.905 145.841H345.905L279.405 276.02H232.621Z" />
      <path d="M41.1206 276.02H208.336L195.73 251.341H74.8362V220.341H179.894L168.144 197.341H74.8362V170.841L154.352 170.341L141.836 145.841H41.1206V276.02Z" />
    </svg>
  );
