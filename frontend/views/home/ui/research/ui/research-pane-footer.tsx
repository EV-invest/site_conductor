  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        <div className="w-10 h-10 shrink-0 rounded-full bg-primary-ink/15 border border-primary-ink/30 hidden sm:flex items-center justify-center text-primary-ink">
      ...
      <div className="flex shrink-0 gap-2">
        <Link
          ...
          className="bg-transparent text-ink border border-ink/30 hover:border-primary-ink hover:text-primary-ink transition-all duration-300 rounded-none font-mono-tech text-[10px] sm:text-[11px] tracking-wider uppercase py-3 px-3 sm:px-4 inline-flex items-center"
          onClick={() =>
            capture("cta_clicked", {
              cta: "read_report",
              report: report.slug,
        ...
        <a
          ...
          download
          className="bg-primary text-on-primary hover:bg-ink hover:text-brand transition-all duration-300 rounded-none font-mono-tech text-[10px] sm:text-[11px] tracking-wider uppercase py-3 px-3 sm:px-4 inline-flex items-center"
          onClick={() =>
            capture("cta_clicked", {
              cta: "download_report",
              report: report.slug,
